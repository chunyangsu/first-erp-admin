<template>
  <div>
    <!-- 打开购物车 -->
    <el-button style="margin-right: 20px; float: right;" type="primary" @click.native="$refs.CartDialog.openCart">打开购物车</el-button>
    <!-- 加入购物车 -->
    <el-button style="margin-right: 20px; float: right;" type="primary" size="mini" icon="el-icon-plus" @click="addCart">加入购物车</el-button>
