<template>
  <div>
    <!-- 打开暂存车 -->
    <el-button v-waves style="margin-right: 20px; float: right;" type="primary" @click.native="$refs.CartDialog.openCart">{{ $t('button.open_cart') }}</el-button>
    <!-- 加入暂存车 -->
    <el-button v-waves style="margin-right: 20px; float: right;" type="primary" icon="el-icon-plus" @click="addCart">{{ $t('button.add_cart') }}</el-button>
