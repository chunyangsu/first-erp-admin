<template>
  <div>
    <el-table ref="proTable" :color="textcolor" :data="list" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" default-expand-all row-key="id" border style="width: 100%">
      <!-- 产品名称 -->
